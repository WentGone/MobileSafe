...
public class AppLockAdapter extends BaseAdapter {
	...
	public AppLockAdapter(List<AppInfoEntity> mAppInfoList, Context context) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.item_listview_lockapp, null);
			vh = new ViewHolder();
			vh.iv_Icon = (ImageView) convertView
					.findViewById(R.id.item_listview_lockapp_IV);
			vh.tv_Name = (TextView) convertView
					.findViewById(R.id.item_listview_lockapp_TV_name);
			vh.iv_State = (ImageView) convertView
					.findViewById(R.id.item_listview_lockapp_IV_State);
		...
		vh.iv_State.setImageResource(R.drawable.lock);
